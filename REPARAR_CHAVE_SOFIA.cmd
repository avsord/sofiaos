...
title Sofia OS - Reparador existente v43
if not exist "%~dp0tools\sofia-iniciar-v43.cjs" (
 echo Reparador v43 nao encontrado. Nao envie sua chave pelo chat.
 pause
 exit /b 1
)
"%SOFIA_NODE%" "%~dp0tools\sofia-iniciar-v43.cjs"
