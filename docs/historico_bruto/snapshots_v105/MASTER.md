...
## v105 — sino de notificações
O preview do sino agora usa um `notification-hover-shell` no HTML e CSS `:hover`/`:focus-within` como mecanismo principal. O JavaScript apenas carrega/atualiza os dados e mantém suporte a clique/teclado.
