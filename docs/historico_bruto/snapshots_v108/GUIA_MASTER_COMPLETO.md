...
# Adendo v108 — páginas limpas

A partir da v108, a Sofia reduz controles redundantes nas páginas. A regra é: a superfície principal deve parecer uma página/documento, e não um painel administrativo.
